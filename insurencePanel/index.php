...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="../API/updateAccidentForInsurance.php" method="POST" style="width:95%;">
    ...
    <div class="container">
    <div class="col-sm-6">
    <img style='border: 1px solid #ccc;  border-radius: 4px;  padding: 5px;  width: 150px;}' alt="Case Main Image" id="img1">
    <img style='border: 1px solid #ccc;  border-radius: 4px;  padding: 5px;  width: 150px;}' alt=" Main Image" id="img2">
    <img style='border: 1px solid #ccc;  border-radius: 4px;  padding: 5px;  width: 150px;}' alt=" Main Image" id="img3">
    <img style='border: 1px solid #ccc;  border-radius: 4px;  padding: 5px;  width: 150px;}' alt=" Main Image" id="img4">
    <img style='border: 1px solid #ccc;  border-radius: 4px;  padding: 5px;  width: 150px;}' alt=" Main Image" id="img5">
    </div>
    <div class="col-sm-6" style="padding: 15px;background-color:#bbb;">
    ...
    <tr>
      <th>Approvel</th>
      <td ><h5 id="approvel"></h5>
      <select name="approvel" style=" width: 150px;">
...
var locations = getData();
  ...
  var iconBase =
          ...
          NOT_SERIOUS: {
            icon: '../images/blue_flag.png'
          },
          WAITIING: {
            icon: '../images/waiting1.png'
          }
        };
...
for (i = 0; i < locations.length; i++)
 ...
 var flag =  locations[i][9]

 latlngset = new google.maps.LatLng(lat, long);

  var marker = new google.maps.Marker({  
          map: map, title: id , position: latlngset ,icon: icons[flag].icon
        });
...
xmlhttp.open("GET", "../API/incuranceAccidentList.php", true);
xmlhttp.send();
...
xmlhttp.open("GET", "../API/incuranceAccidentTable.php", true);
xmlhttp.send();
